...
class GameSceneCongratulations511 extends GameSceneCongratulationsBase {
  PShader sd;
  int startMillis;
  int startCount;
  ...
  @Override void setup() {
    ...
    sd = loadShader("data/511/Shadertoy.glsl");
    sd.set("iResolution", (float)width, (float)height, 0.0f);
    sd.set("iChannel0", loadImage("data/511/iChannel0.png"));
